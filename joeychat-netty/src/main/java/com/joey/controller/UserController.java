...
import com.joey.enums.OperatorFriendRequestTypeEnum;
import com.joey.enums.SearchFriendsStatusEnum;
import com.joey.pojo.Users;
import com.joey.pojo.bo.UsersBO;
import com.joey.pojo.vo.MyFriendsVO;
import com.joey.pojo.vo.UsersVO;
import com.joey.service.UserService;
import com.joey.utils.IMoocJSONResult;
import com.joey.utils.MD5Utils;
...
public class UserController {
	...
	public IMoocJSONResult uploadFaceBase64(@RequestBody UsersBO userBO) throws Exception {
		...
		//文件存放位置
		String userFacePath = "D:\\eclipse_Mars\\workspace\\joeychat-netty\\img\\face_image" + userBO.getUserId() + "userface64.png";
...
//		"dhawuidhwaiuh3u89u98432_80x80.png"
	...
	public IMoocJSONResult getUnReadMsgList(String acceptUserId) {
		...
		// 查询列表
		List<com.joey.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
		System.out.println(acceptUserId+"的未读下消息："+unreadMsgList);
